...
public class PersonalFriends extends Acquaintances implements Serializable{
    ...
    @Override
    public void setFirstExclusiveInformation(String Events) {
        setEvents(Events);
    }

    @Override
    public void setSecondExclusiveInformation(String AContext) {
        setAContext(AContext);
    }

    @Override
    public void setThirdExclusiveInformation(String ADate) {
        setADate(ADate);
    }
