...
public class CasualAcquaintances extends Acquaintances implements Serializable {
    ...
    @Override
    public void setFirstExclusiveInformation(String WhenWhere) {
        setWhenWhere(WhenWhere);
    }

    @Override
    public void setSecondExclusiveInformation(String Circumstances) {
        setCircumstances(Circumstances);
    }

    @Override
    public void setThirdExclusiveInformation(String OtherInfo) {
